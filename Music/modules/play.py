...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    img = Image.open("etc/MusicSq.png")
   ...
   # img_arr =np.array(image3)
    ...
    # fonts
    font1 = ImageFont.truetype(r'etc/Music.otf', 30)
    font2 = ImageFont.truetype(r'etc/Music.otf', 60)
    font3 = ImageFont.truetype(r'etc/Music.otf', 49)
...
async def play(_, message: Message):
    ...
    [
       ...
       [
        ...
        file_path = await Music.tgcalls.convert(
    ...
    [
       ...
       [
        ...
        file_path = await Music.tgcalls.convert(x)
    else:
